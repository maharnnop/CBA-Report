namespace BestPolicyReport.Models.PremInDirectReport
{
    ...
    {
        public PremInDirectReportResult() { }
        public PremInDirectReportResult(List<PremInDirectData> datas , int count) {
            this.Count = count;
            this.Datas = datas;
        }
        public List<PremInDirectData>? Datas { get; set; }  
        public int Count { get; set; }
    }
    public class PremInDirectData
    {
